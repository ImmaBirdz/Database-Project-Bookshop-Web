    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @auth
                    <x-nav-link :href="route('wishlist.index')" :active="request()->routeIs('wishlist.index')" class="mr-9">
                        {{ __('WishList') }}
                    </x-nav-link>
                ...
                @else
                    <x-nav-link :href="route('login')" class="mr-9">
                        {{ __('Log in') }}
                    </x-nav-link>
                    <x-nav-link :href="route('register')" class="mr-9">
                        {{ __('Register') }}
                    </x-nav-link>
                @endauth
            </div>
