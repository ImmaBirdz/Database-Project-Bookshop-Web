        ...
        <div>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-4">
                ...
                <div class="bg-white shadow-lg rounded-lg p-4">
                    <img src="{{ $book->book_cover }}" alt="{{ $book->book_title }}" class="w-full h-auto mb-4" style="width: 200px; height: 300px; aspect-ratio: 2/3;">
                    ...
                    <a href="{{ route('tag.show', $book->book_category) }}" class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mt-2 mb-2">
                        {{ $book->book_category }}
                    </a>
